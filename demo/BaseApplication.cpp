...
{	
	...
	settings.insert(std::make_pair("title", "Ogre-FFmpeg-Videoplayer Demo"));
	settings.insert(std::make_pair("FSAA", "0"));
    settings.insert(std::make_pair("vsync", "false"));

	mWindow = Root::getSingleton().createRenderWindow("Ogre-FFmpeg-Videoplayer Demo", 800, 600, false, &settings);
